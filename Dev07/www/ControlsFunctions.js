...
function LoadController(page, control, editRow, passOnly) {
    ...
    setTimeout(function () {
        ...
        setTimeout(LoadController2, (DevicePosition.msg == "Failed to get position"?0:2000), page, control,editRow);

    }, 200);
}


function LoadController2(page, control,editRow, passOnly) {
        ...
        var fieldLanguage = false;
         if(sectionLang !== false){
            ...
            if (FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].DefaultValue !== undefined)
                ...
                dValue = eval(FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].DefaultValueJS);
            }
            ...
            if(editData != undefined){
                ...
                /*
                try{
                dValue = eval("editData.DataField");
                console.log("!" + dValue);
                }
                catch(e){};*/
            }
            ...
            var sDisplayField = FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].ControlVisible == "false" ? "none" : "block";
    ...
    if( FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].JSONExtra !=undefined){
           for(var ixS =0; ixS < FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].JSONExtra.AdditionalSettings.length; ixS++){
                if(FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].JSONExtra.AdditionalSettings[ixS].Key=="showonlywhen"){
                       ...
                       var arrFieldInfo = [FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].DataField, sField2Watch[0], sField2Watch[1]];

console.log( arrFieldInfo[1]  + " - " + $('[field_dest="' + arrFieldInfo[1] + '"]').val() + " == " +arrFieldInfo[2]);
...
iCurrentActivePage=-1;
            ...
            $(c).append(
                $("<div>")
                    .attr("datafid", FormSet.applications[global_applicationid].forms[page].Sections[xSection].Fields[xFields].DataField)
